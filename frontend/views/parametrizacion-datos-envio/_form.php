...
<div class="parametrizacion-datos-envio-form">
    ...
    ?>
     <?= $form->field($model, 'DatoXml')->textInput(['maxlength' => true,'placeholder' => "Ingrese el DatoXml"]) ?>
  <!--
     $form->field($model, 'DatoXml')->dropDownList($var,['id'=>'ver1'],
            ['prompt'=>'Seleccione una opcion'])*/ -->
   
    <?= $form->field($model, 'Campo')->textInput(['maxlength' => true,'placeholder' => "Ingrese el Campo"]) ?>
   <p class="text-warning text-center " id="Nota" style='display:none;'><strong>NOTA: !!Seleccionaste variable completar el valor con nombres de Tagxml!!</strong></p>
    ...
    <?= $form->field($model, 'Valor')->textInput(['maxlength' => true,'placeholder' => "Ingrese el valor"]) ?> 
