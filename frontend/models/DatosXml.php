...
class DatosXml extends \yii\db\ActiveRecord
{
   //  public $Union;
    ...
    {
        return [
            [['CodDocumento', 'RazonSocial', 'ruc', 'NombreComercial', 'Establecimiento','Secuencial','PuntoEmision', 'FechaEmision', 'TotalSinImpuesto', 'TotalDescuento', 'BaseImponible', 'Tarifa', 'Valor', 'ImporteTotal','AutorizacionNumero','Estado'], 'required'],
            [['Tarifa'], 'number'],
            [['Estado'], 'string'],
            [['FechaEmision'], 'safe'],
