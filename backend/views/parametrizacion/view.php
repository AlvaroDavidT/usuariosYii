...
$this->title = $model->parametrizacion_id;
...
<div class="parametrizacion-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->parametrizacion_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->parametrizacion_id], [
